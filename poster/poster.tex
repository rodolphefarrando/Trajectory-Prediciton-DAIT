...
\centerline{\includegraphics[scale = 0.8]{figure/intro2}}
...
\centerline {\includegraphics[scale = 0.8]{figure/afterrot}}
...
\centerline {\includegraphics[width=0.3\textwidth]{figure/examplepres}}
\captionof{figure}{}

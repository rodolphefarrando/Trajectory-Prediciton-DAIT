...
\Large \texttt{\{rodolphe.farrando, romain.gratier\}@epfl.ch}\\
\end{minipage}
%
...
\includegraphics[width=0.8\linewidth]{./figure/hyperparam}
...
\begin{center}\vspace{1cm}
\includegraphics[width=0.8\linewidth]{./figure/fig_1552}
\captionof{figure}{\color{Green} Figure caption}
\end{center}\vspace{1cm}

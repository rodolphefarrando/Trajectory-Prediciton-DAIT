...
\begin{enumerate}
\justifying
\onslide<1->{\item Isolate each trajectory along with his interaction}
...
\onslide<4->{\item For each frame, if there is an interacting pedestrian we add its coordinates and speed otherwise we add zeros}

...
\title{DAIT Project}
\subtitle{Trajectory Prediction for Human-Human Interaction}
...
\multicolumn{1}{|c|}{}                                   & \textbf{Mean}  &4.696                 & 5.144                &4.674                 &                & 1.16            & 0.768           & 0.817           & 0.837                                 \\ \cline{2-10} 
\multicolumn{1}{|c|}{\multirow{-2}{*}{\textbf{Coord.}}} & \textbf{Final} &10.246                 & 7.009                &10.501                 &                & 1.269           & 0.911           & 1.087           & 1.011                                 \\ \hline
\multicolumn{1}{|c|}{}                                   & \textbf{Mean}  &0.567                 &5.133                 &1.911                 &                & 0.742           & 0.397           & 0.448           & {\color[HTML]{FE0000} \textbf{0.461}} \\ \cline{2-10} 
\multicolumn{1}{|c|}{\multirow{-2}{*}{\textbf{Speed}}} & \textbf{Final} &0.77                 &6.971                 &3.882                 &                & 1.433           & 0.716           & 0.874           & {\color[HTML]{FE0000} \textbf{0.863}} \\ \hline
\multicolumn{1}{|c|}{}                                   & \textbf{Mean}  &1.269                 &5.134                 &1.762                 &                & 0.519           & 0.484           & 0.568           & 0.511                                 \\ \cline{2-10} 
\multicolumn{1}{|c|}{\multirow{-2}{*}{\textbf{2 Loss}}} & \textbf{Final} &2.727                 &6.978                 &3.546                 &                & 0.979           & 0.871           & 1.093           & 0.946                                 \\ \hline
\multicolumn{1}{|c|}{}                                   & \textbf{Mean}  &0.549                 &5.135                 &3.829                 &                & 0.537           & 0.473           & 0.576           & 0.51                                  \\ \cline{2-10} 
\multicolumn{1}{|c|}{\multirow{-2}{*}{\textbf{3 Loss}}} & \textbf{Final} &0.758                 &6.983                 &4.962                 &                & 0.992           & 0.86            & 1.125           & 0.95                                  \\ \hline
\end{tabular}
\end{adjustwidth}
\end{table}
\end{frame}
